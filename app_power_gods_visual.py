    ...
    if password == "dioses123":
        ...
        with col1:
            if st.button("🧑 Crear nuevo usuario", use_container_width=True):
                st.session_state.opcion_admin = "Crear nuevo usuario"
        with col2:
            if st.button("📝 Crear nueva rutina", use_container_width=True):
                st.session_state.opcion_admin = "Crear nueva rutina"
        with col3:
        ...
        # Crear nuevo usuario
        if st.session_state.opcion_admin == "Crear nuevo usuario":
        ...
        # Crear nueva rutina
        if st.session_state.opcion_admin == "Crear nueva rutina":
        ...
        if st.session_state.opcion_admin == "Modificar rutina existente":
            st.markdown("---")
